...
export function PendingFriendsList() {
    ...
    return (
        <div className="flex flex-col divide-y" >
            ...
            {friends?.length === 0 && <FriendsListEmpty>You dont have any pending friend requests</FriendsListEmpty>}
            {friends?.map((user) => (
                <FriendItem key={friend.username} username={user.username} image={user.image}>
                    <IconButton
                        title="Accept"
...
export function AcceptedFriendsList() {
    ...
    return (
        <div className="flex flex-col divide-y" >
            ...
            {users.length === 0 && <FriendsListEmpty>You dont have any friends yet</FriendsListEmpty>}
            {users.map((user) => (
